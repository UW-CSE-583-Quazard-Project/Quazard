...
# import pandas as pd
# import numpy as np
import reader_gui, decapitator_gui, executioner_gui, janitor_gui, frankenstein_gui, \
    converter_gui, outputer_gui
def main():
    root = tk.Tk()
    ...
    converter_gui.create_converter_tab(tab_control)
